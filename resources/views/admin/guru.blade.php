                        ...
                        <form action="{{ route('admin.storeGuru') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="name"
                                    class="form-control rounded-lg border-light bg-light py-4"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="password" name="password"
                                    class="form-control rounded-lg border-light bg-light py-4" placeholder="••••••••"
                                    required>
                            </div>
                            <button type="submit"
                                class="btn btn-primary btn-block btn-lg text-bold rounded-lg shadow-sm">Daftarkan
                                Sekarang</button>
                        </form>
                    </div>
                </div>
                                        ...
                                        <tr class="border-bottom border-light">
                                            <td class="px-4 py-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="bg-primary-soft rounded-circle p-2 mr-3 text-primary text-bold"
                                            ...
                                            <td class="px-4 py-3 text-center">
                                                <div class="btn-group">
                                                    <a href="{{ route('dashboard') }}?view_guru={{ $guru->id }}"
                                                        class="btn btn-light btn-sm rounded-pill mr-1 px-3">
...
@section('js')
    <script>
        // Script otomatis apply dark mode dari localStorage
        (function() {
